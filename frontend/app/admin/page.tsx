  ...
  return (
    <div className='container-custom py-12'>
      <div className="flex items-center justify-between mb-10">
        ...
        <span className="text-sm px-3 py-1 bg-slate-100 text-slate-500 rounded-full">Admin Area</span>
      </div>
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400 text-sm">/posts/</span>
                  <input
                    id='slug'
                    type='text'
                    value={formData.slug}
              ...
              <div>
                <label htmlFor='content' className='block mb-1.5 text-sm font-medium text-slate-700'>
                  本文
                </label>
                <textarea
                  id='content'
                    ...
                    <div className="flex justify-between items-start gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 text-xs text-slate-400 mb-2">
                           <span className="font-mono bg-gray-100 px-1.5 py-0.5 rounded text-slate-500">/{post.slug}</span>
                           <span>•</span>
